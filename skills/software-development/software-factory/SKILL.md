...
- `references/workflow-registry-method.md` — Four-view workflow registry for discovering and documenting all paths through a system before building. Use when entering an unfamiliar codebase or designing new system flows.
