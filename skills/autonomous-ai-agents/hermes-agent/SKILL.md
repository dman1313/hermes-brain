...
# External skill install workflow: references/external-skill-installation.md
...
**Profile repair (missing config/.env/alias):** `references/profile-repair.md` — step-by-step fix for hollow profiles that have skills but no working configuration.
```
